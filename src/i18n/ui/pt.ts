...
export const messagesPt = {
  ...
  blog: {
    ...
    tags: 'Tags',
    answerTitle: 'Respostas rápidas',
    answerWhat: 'O que é?',
    answerWho: 'Para quem é?',
    answerFactors: 'Fatores de seleção',
    answerModels: 'Modelos Pinjin relacionados',
    sourcesTitle: 'Fontes / Referências',

...
export const companyEntity = {
  ...
  customers: {
    en: 'Construction contractors, equipment buyers and project teams that need catalogue electric pumps, diesel pumps, mixer pumps or spraying machines.',
    zh: '需要目录电动泵、柴油泵、搅拌泵或喷涂机的工程承包商、设备采购方与项目团队。',
    pt: 'Empreiteiras, compradores e equipes de obra que precisam de bombas elétricas, a diesel, misturadoras ou máquinas de projeção do catálogo.',
    ar: 'مقاولون ومشترون وفرق مشاريع يحتاجون مضخات كهربائية أو ديزل أو مضخات خلط أو آلات رش من الكتالوج.',

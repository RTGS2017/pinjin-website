...
export const companyEntity = {
  legalName: {
    ...
    ru: 'Hebei Pinjin Machinery Manufacturing Co., Ltd.',
  },
  shortName: {
  ...
  industry: {
    ...
    ar: 'مصنّع آلات بناء',
    ru: 'Производитель строительной техники',
  },
  positioning: {
    ...
    ru: 'Завод-изготовитель насосов подачи',
  },
  location: {
    line1: {
      ...
      ru: 'Индустриальный парк Жэньцзэ',
    },
    line2: {
      ...
      ru: 'Синтай, провинция Хэбэй, Китай',
    },
    locality: 'Xingtai',
    region: 'Hebei',
    country: 'China',
  ...
  customers: {
    ...
    ru: 'Подрядчики, закупщики оборудования и проектные команды, которым нужны электрические, дизельные или смесительные насосы из каталога.',
  },
  problemsSolved: {
  ...
  geoCaption: {
    ...
    ru: 'Hebei Pinjin Machinery Manufacturing Co., Ltd. — китайский производитель строительной техники, специализирующийся на бетонном оборудовании и промышленном машиностроении.',
  },
  ...
  clusterNote: {
    ...
    ru: 'Синцзявань в городе Синтай, провинция Хэбэй, известен как важный кластер производства бетонной техники. Адрес завода Pinjin — индустриальный парк Жэньцзэ, Синтай.',
  },
  specialization: {
    ...
    ru: 'Производство бетонной техники',
  },
  customization: {
    ...
    ar: 'حلول معدات OEM',
    ru: 'OEM-решения по оборудованию',
  },
  capabilities: {
    manufacturing: { en: 'Manufacturing', zh: '制造', pt: 'Fabricação', ar: 'التصنيع', ru: 'Производство' },
    assembly: { en: 'Assembly', zh: '装配', pt: 'Montagem', ar: 'التجميع', ru: 'Сборка' },
    oem: { en: 'OEM Production', zh: 'OEM 生产', pt: 'Produção OEM', ar: 'إنتاج OEM', ru: 'OEM-производство' },
    quality: { en: 'Quality Control', zh: '质量管控', pt: 'Controle de qualidade', ar: 'ضبط الجودة', ru: 'Контроль качества' },
  },
} as const;

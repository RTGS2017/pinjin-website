...
This page is for Pinjin bomba reboques assembled in Xingtai. It is not a boom-pump or mixing-plant manual. It does not replace the machine instruction supplied with the unit.

![Trailer concrete pump assembly at Hebei Pinjin Machinery Xingtai factory](/images/factory/pinjin-trailer-concrete-pump-assembly.webp)
*Trailer concrete pump assembly, Xingtai factory*

## Causes we can name without inventing a formula

From the Xingtai daily checklist and from ACI 304.2R-17’s pumpability notes:

- Mix that segregates, or stone larger than the published max agregado / pipe DN (see [aggregate size](/blog/fine-stone-concrete-pump-aggregate-size/)).
...
- Leftover set concrete in the hopper, válvula S or reducer from the previous pour.
...
4. válvula S, cutting ring and spectacle plate observed; photograph chips.
...
If the valve or pipe looks damaged, photograph it and send the model slug to the Xingtai factory. We will quote peças de desgaste against the size on the machine.

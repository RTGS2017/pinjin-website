...
This page is for Pinjin прицепной насосs assembled in Синтай. It is not a boom-pump or mixing-plant manual. It does not replace the machine instruction supplied with the unit.

![Trailer concrete pump assembly at Hebei Pinjin Machinery Синтай factory](/images/factory/pinjin-trailer-concrete-pump-assembly.webp)
*Trailer concrete pump assembly, Синтай factory*

## Causes we can name without inventing a formula

From the Синтай daily checklist and from ACI 304.2R-17’s pumpability notes:

- Mix that segregates, or stone larger than the published max заполнитель / pipe DN (see [aggregate size](/blog/fine-stone-concrete-pump-aggregate-size/)).
...
- Leftover set concrete in the hopper, S-клапан or reducer from the previous pour.
...
4. S-клапан, cutting ring and spectacle plate observed; photograph chips.
...
Quoted from ACPA’s 1 November 2022 safety alert and the ACPA mechanics safety procedures. This is not a Pinjin-invented method.
...
If the valve or pipe looks damaged, photograph it and send the model slug to the Синтай factory. We will quote быстроизнашивающиеся детали against the size on the machine.

## Related Pinjin pages

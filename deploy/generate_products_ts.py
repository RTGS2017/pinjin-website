...
PRODUCTS = [
    ...
    P(
        ...
        name_en="HBT60-13-146RS Concrete Pump",
        name_zh="HBT60-13-146RS混凝土泵",
        cat="concrete-pump",
        short_en="HBT60-13-146RS concrete pump model listed in the catalogue without detailed parameters.",
        short_zh="目录列出的HBT60-13-146RS混凝土泵型号，暂无详细参数。",
        intro_en="HBT60-13-146RS Concrete Pump appears in the Hebei Pinjin Machinery product catalogue by model name only. Detailed technical parameters are not provided in the current catalogue document. Please contact Pinjin by email for the latest parameter sheet before selection.",
        intro_zh="HBT60-13-146RS混凝土泵在河北品锦机械产品目录中仅标注型号，当前目录未提供详细技术参数。选型前请邮件联系品锦索取最新参数表。",
        apps=[
            ("Concrete pump model inquiry", "混凝土泵型号询盘"),
            ("Construction project equipment shortlisting", "建筑项目设备初选"),
            ("Catalogue model confirmation with manufacturer", "与厂家确认目录型号"),
        ],
        features=[
            ("Catalogue model HBT60-13-146RS", "目录型号HBT60-13-146RS"),
            ("Parameter sheet available on inquiry", "可通过询盘获取参数表"),
            ("Manufactured by Hebei Pinjin Machinery", "由河北品锦机械制造"),
        ],
        specs=[],
        seo_primary="HBT60-13-146RS concrete pump",
        seo_sec=["concrete pump manufacturer China", "HBT concrete pump"],
        seo_lt=["HBT60-13-146RS concrete pump manufacturer inquiry"],
        desc_en="Hebei Pinjin Machinery lists the HBT60-13-146RS concrete pump model in China. Contact the manufacturer for detailed specifications for construction applications.",
        desc_zh="河北品锦机械在中国提供HBT60-13-146RS混凝土泵型号，详细参数请联系厂家确认，适用于建筑相关选型询盘。",
        geo_cat_en="Concrete Pump Equipment",
        geo_cat_zh="混凝土泵设备",
        what=("A concrete pump model listed in the catalogue without published detailed specs.", "目录列出但未公布详细参数的混凝土泵型号。"),
        who=("Buyers who need manufacturer confirmation of HBT60-13-146RS parameters.", "需要厂家确认HBT60-13-146RS参数的采购方。"),
        where=("Any project shortlisting this model pending parameter confirmation.", "将此型号列入候选并待确认参数的项目。"),
        adv=("Direct manufacturer inquiry path for missing catalogue details.", "缺失目录细节时可直接向厂家询盘确认。"),
    ),
]
